...
namespace Paradise.Migrations
{
    ...
    [Migration("20210604225903_insertPlantComments")]
    partial class insertPlantComments
    {
            ...
            modelBuilder.Entity("Paradise.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            FlowerId = 2,
                            Message = "You'll love these bright-blue beauties as much as the birds and butterflies do.",
                            PlantId = 0
                        },
                        new
                        {
                            ID = 2,
                            FlowerId = 4,
                            Message = "These tiny beauties flower profusely until first frost, brightening beds, borders, and hanging baskets even in part shade. They'll even tolerate the hot, dry summer days in the South leading up to a cooler fall.",
                            PlantId = 0
                        },
                        new
                        {
                            ID = 3,
                            FlowerId = 5,
                            Message = "You might know colchicum by its other name: autumn crocus. As you would expect, they do bloom between August and September, but without any foliage. The leaves only appear in the spring before dying back.",
                            PlantId = 0
                        },
                        new
                        {
                            ID = 4,
                            FlowerId = 0,
                            Message = @"If you're more of a waterer, an excellent plant is a Chinese evergreen,Fried says.Aglaonema can withstand excess H2O,
              ...
              and red.",
                        ...
                        new
                        {
                            ID = 5,
                            FlowerId = 0,
                            Message = "Pilea peperomioides grows best in a shady spot (or winter windowsill) with weekly watering, according to The Little Book of House Plants and Other Greenery.",
                            PlantId = 4
                        });
                });
