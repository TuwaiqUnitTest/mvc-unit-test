...
namespace Event_Hall.Migrations
{
    ...
    [Migration("20210604192232_addedSomeEvents3")]
    partial class addedSomeEvents3
    {
            ...
            modelBuilder.Entity("Event_Hall.Models.EventModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 122222,
                            Description = "Entrepreneur Elon Musk is a man with many plans. The founder of PayPal, Tesla Motors and SpaceX sits down with TED curator Chris Anderson to share details about his visionary projects, which include a mass-marketed electric car, a solar energy leasing company and a fully reusable rocket.",
                            Duration = "2 Hours",
                            HallId = 1,
                            Image = "https://c.ndtvimg.com/2021-03/9op9k9ko_elon-musk-reuters_625x300_25_March_21.jpg",
                            Name = "the Mind Behind Tesla, Spacex and Solarcity",
                            PresentorId = 2,
                            Time = "Sunday, August 12, 2021 3:30:00 PM"
                        });
                });
