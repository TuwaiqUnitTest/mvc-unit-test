...
namespace plantsShop.Controllers
{
    ...
    {
        private List<CatModel> cats = new List<CatModel>()
            {
                new CatModel {  id=1, name ="Siamese cat",
                ...
                new CatModel { id =2, name = "Persian cat", 
                ...
                new CatModel {  id=3, name = "Bengal cat",
                ...
                new CatModel { id=4,  name = "Sphynx cat",
